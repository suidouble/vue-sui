            ...
            <div class="signinwithsui_dialog_inner_card">
                ...
                <div class="signinwithsui_dialog_list">
                    ...
                    <template v-for="(adapter, index) in adapters" v-bind:key="index">
                        ...
                        <div  class="signinwithsui_dialog_item" 
                            :class="{signinwithsui_dialog_item_disabled: adapter.isDefault}" @click="onAdapterClick(adapter)" 
                            v-if="adapter && adapter.name && (adapter.isDefault || adapter.okForSui)">
